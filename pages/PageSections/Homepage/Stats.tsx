	...
	return (
		<section className="mb-12">
			<div className="global-container">
				<div className="border border-gray-200 rounded-[20px] flex items-center p-6">
					...
					<span className="w-[20px] h-[20px] rounded-full bg-[#E59AFF]"></span>
					<div className="flex-1 flex justify-center items-center">
						<div className="text-center">
					...
					<span className="w-[20px] h-[20px] rounded-full bg-[#9AFFC2]"></span>
					<div className="flex-1 flex justify-center items-center">
						<div className="text-center">
					...
					<span className="w-[20px] h-[20px] rounded-full bg-[#FF9A9A]"></span>
					<div className="flex-1 flex justify-center items-center">
						<div className="text-center">
